...
def produce_simulation(src_param_arr, vertices, multi_block_arr, ft_freq, time, obs_vol, src_pt_arr, lsts,
    ...
    src_pos = x[x_src_index], y[y_src_index], z[z_src_index]
    ...
    dipole_at_obs = inv.produce_adjoint_area_even(old_field, src_pos, ft_freq, adj_dt, [x, y, z], flux_indices)[0]
    ...
    for i in range(iterations):
        ...
        # Adjoint source/s
        dipole_at_obs = dipole_at_obs = inv.produce_adjoint_area_even(old_field, src_pos, ft_freq, adj_dt, [x, y, z], flux_indices)[0]
