...
POL_VEC = np.array([0, 1, 1])

beams = mhg.make_hg_beam_any_dir(K_VEC, POL_VEC, FCEN, WAVELENGTH, [sx, sy, sz], [-3, 0, 0], waist=WAIST,
                                 m=0, n=0)
# beams =  [mhg.make_hg_beam(FCEN, WAVELENGTH, [0, sy, sz], [-3, 0, 0], dir_prop=0, waist=WAIST,
#                  m=0, n=0)]
...
plt.pcolormesh(x, y, np.transpose(plots_2D[0]), cmap='seismic', alpha=1)
