...
ax.pcolormesh(x, y, np.transpose(helicity_density), cmap='RdGy', alpha=1, vmin=-1, vmax=1)
ax.set_title(f'Superchiral Helicity Density 3 plane waves')

# ax[1].pcolormesh(x, y, np.transpose(e_sq), cmap='OrRd',vmax=5,vmin =0, alpha=1)
